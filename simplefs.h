...
typedef struct {
  ...
  char name[128];
  int written_bytes;   //utilizzato per la seek
  int  size_in_bytes;
  int size_in_blocks;
...
int SimpleFS_readDir(char** names, DirectoryHandle* d, int* flag); //MODIFICATA: aggiunto un array di flag ad indicare se il blocco letto isdir
